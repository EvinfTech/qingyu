<template>
	...
	<view class="page">
		<u-navbar class="nav-bar" title="登录"  leftIconSize="0" :autoBack="true">
		</u-navbar>
		<view class="loginBox flex flex-direction align-center">
			<view class="imgBox">
				<image src="/static/images/common/logo.svg" mode="" class="h-full w-full" />
			</view>
			<view class="title">欢迎登录奇羽</view>
			<button class="btn-wechat-login" @tap="onWechatLogin">微信快捷登录</button>
			<!-- <button class="btn-wechat-login" open-type="getPhoneNumber" bindgetphonenumber="getPhoneNumber">微信快捷登录</button> -->
		</view>
	</view>
</template>
