...
if (!Array) {
  ...
  (_easycom_u_navbar2 + _easycom_u__textarea2 + _easycom_u_upload2)();
}
...
if (!Math) {
  (_easycom_u_navbar + _easycom_u__textarea + _easycom_u_upload)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o(($event) => $data.error = $event),
    c: common_vendor.p({
      placeholder: "请输入...",
      modelValue: $data.error
    }),
    d: common_vendor.o($options.afterRead),
    e: common_vendor.o($options.deleteImg),
    f: common_vendor.p({
